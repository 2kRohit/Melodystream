...
useEffect(() => {
  ...
  const fetchMusic = async () => {
    try {
      const response = await axios.get(`http://localhost:8000/api/music/getmusicbyid/${musicId}`);
      const responsedata = await axios.get(`http://localhost:8000/api/music/getmusicbycategory/${response.data.category}/${musicId}`);
      setTrackList([response.data, ...responsedata.data]);
