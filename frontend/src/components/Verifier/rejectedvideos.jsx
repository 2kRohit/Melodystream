...
const VideoList = () => {
  ...
  const fetchVideos = async () => {
    try {
      const response = await axios.get(`http://localhost:8000/api/verifier/rejectedvideos`);
  ...
  return (
    <Sidebar>
      <div className="bg-gray-900 flex flex-col justify-start items-center py-0">
        ...
        <h2 className="text-center text-2xl text-blue-500 italic p-1 mb-0 mt-2 font-semibold">Rejected Video List</h2>
