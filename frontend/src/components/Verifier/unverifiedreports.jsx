...
const User = () => {
  ...
  const fetchuser = async () => {
    try {
      const response = await axios.get(`http://localhost:8000/api/verifier/unverifiedreports`);
  ...
  return (
    <Sidebar>
      <div className="bg-gray-900 min-h-screen flex flex-col justify-start items-center py-0">
        ...
        <h2 className="text-center text-2xl text-blue-500 italic p-1 mb-0 mt-2 font-semibold">Unverified Reports</h2>
