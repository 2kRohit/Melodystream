...
import { MdOutlinePermContactCalendar, MdOutlineReport, MdOutlineVerifiedUser } from 'react-icons/md';
    ...
    <Sidebar>
      <div className="bg-gray-900 min-h-screen text-white p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-gray-800 p-8 rounded-lg shadow-xl flex flex-col items-center justify-center">
            <MdOutlineReport className="text-5xl text-red-500 mb-4" />
            <h2 className="text-2xl font-bold mb-2">Reports</h2>
            <p className="text-xl text-gray-300">Total: {data.report}</p>
          </div>
          <div className="bg-gray-800 p-8 rounded-lg shadow-xl flex flex-col items-center justify-center">
            <MdOutlinePermContactCalendar className="text-5xl text-sky-500 mb-4" />
            <h2 className="text-2xl font-bold mb-2">Contact</h2>
            <p className="text-xl text-gray-300">Total: {data.contact}</p>
          </div>
        </div>
      </div>
    </Sidebar>
