  ...
  return (
    <SidebarForm>
      <div className="bg-gray-900 min-h-screen flex flex-col justify-start items-center py-0">
        <h1 className="text-3xl font-bold text-white mb-2 text-center w-full">Verified Video List</h1>
        <div className="w-full max-w-3xl overflow-x-auto">
          {videos.length === 0 ? (
            <p className="text-white text-center">No videos available!</p>
          ) : (
            <table className="w-full bg-gray-800 rounded-lg table-fixed video-table">
              <thead>
                <tr>
                  ...
                  <th className="border-b border-gray-700 bg-gray-900 p-2 text-white text-center">Visibility</th>
              ...
              <tbody>
                {videos.map((video) => (
                  <tr key={video.id} className="text-center">
                    ...
                    <td className="border-b border-gray-700 p-2 capitalize">{video.visibility}</td>
